            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav align-items-center gap-2">
                    ...
                    <li class="nav-item ms-lg-3">
                        <a class="nav-link btn px-4 fw-semibold active" style="border: 2px solid #967bb6; color: #967bb6; border-radius: 50px;" href="login.php">Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn px-4 text-white fw-semibold shadow-sm" style="background-color: #967bb6; border-radius: 50px;" href="register.php">Signup</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <form id="loginForm" method="POST" action="">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group shadow-sm rounded bg-white">
                            ...
                            <input type="password" class="form-control form-control-lg border-start-0 border-end-0 shadow-none" id="password" name="password" placeholder="Enter your password">
                    ...
                    <div class="text-center">
                        <p class="mb-0 fw-medium">Don't have an account? <a href="register.php" class="text-theme text-decoration-none fw-bold">Sign up</a></p>
                    </div>
                </form>
            </div>
        </div>
